 ...
 * apps/api/src/types/scan.ts — the two MUST stay in sync. We deliberately
...
/**
 * Client-local region preference — never server-persisted (no accounts in v1).
 * Tracking `source` lets the UI say "detected from your device settings"
 * versus "you chose this", per the hybrid model in FR-010/FR-010a.
 */
