 ...
 * group plus full-screen routes that sit OUTSIDE the tab bar (visual
 * search — feature 008's Subject Lift surface, superseding the 003 demo
 * route) — native stack transitions are UIKit spring-driven and
